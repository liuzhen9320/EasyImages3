...
//Application Title
define('APP_TITLE', $config['title'] . ' Manager');
...
$config_file = __DIR__.'/../config/config.manager.php';
...
if (isset($_POST['ajax']) && !FM_READONLY) {
    ...
    if (isset($_POST['type']) && $_POST['type'] === 'upload') {
        ...
        echo json_encode(array('fail' => array('message' => 'Remote URL uploads are disabled')));
        exit();
    }
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <div class="path">
        ...
        <div class="card mb-2 fm-upload-wrapper <?php echo fm_get_theme(); ?>">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo htmlspecialchars(FM_SELF_URL) . '?p=' . fm_enc(FM_PATH) ?>" method="post" class="dropzone" id="fileUploader" enctype="multipart/form-data">
                    <?php fm_csrf_field(); ?>
    ...
    <script src="<?php static_cdn(); ?>/public/static/tinyfilemanager/dropzone.min.js"></script>
    <script>
...
function fm_get_translations($tr) {
    try {
        $content = @file_get_contents(APP_ROOT .'/public/static/tinyfilemanager/translation.json');
        if($content !== FALSE) {
...
<script src="<?php static_cdn(); ?>/public/static/tinyfilemanager/jquery.slim.min.js"></script>
...
<head>
    ...
    <?php if($favicon_path) { echo '<link rel="icon" href="'.fm_enc($favicon_path).'" type="image/png">'; } ?>
    <title><?php echo fm_enc(APP_TITLE) ?></title>
    <link rel="stylesheet" href="<?php static_cdn(); ?>/public/static/tinyfilemanager/bootstrap.min.css">
    <link rel="stylesheet" href="<?php static_cdn(); ?>/public/static/tinyfilemanager/font-awesome.min.css">
    <link rel="stylesheet" href="<?php static_cdn(); ?>/public/static/tinyfilemanager/ekko-lightbox.css" />
    <?php if (FM_USE_HIGHLIGHTJS): ?>
    <link rel="stylesheet" href="<?php static_cdn(); ?>/public/static/tinyfilemanager/<?php echo FM_HIGHLIGHTJS_STYLE ?>.min.css">
    <?php endif; ?>
    <style>
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE):
        ...
        ?>
    <script src="<?php static_cdn(); ?>/public/static/tinyfilemanager/ace.js"></script>
    <script>
